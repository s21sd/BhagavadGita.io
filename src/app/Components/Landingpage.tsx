        ...
        <div className=" flex flex-col justify-between items-center mt-10">
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="flex flex-col text-center w-full mb-16 mt-5">
                    <h1 className="text-3xl font-bold title-font mb-5 text-white tracking-widest">Discover the Bhagavad Gita</h1>
                    <p className="lg:w-[90%] font-semibold mx-auto leading-relaxed mb-1 text-white">"When a person responds to the joys and sorrows of others as if they were his own, he has attained the highest state of spiritual union."</p>
                    <p className="lg:w-2/3 font-semibold mx-auto leading-relaxed text-white">Immerse yourself in the timeless teachings of the Bhagavad Gita, a spiritual guide that has inspired millions across the world.</p>
                </div>
