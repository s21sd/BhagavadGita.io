...
const Landingpage = () => {
    ...
    return (
        <motion.div initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            transition={transition1} className=" flex flex-col justify-between items-center mt-10">
            <div className="container px-5 py-24 mx-auto">
                ...
                <motion.div initial={{ opacity: 0, y: '-50%' }}
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: '-50%' }}
                    transition={{ type: 'spring', stiffness: 100, damping: 10 }} className="flex flex-col text-center w-full mb-16 mt-5">
